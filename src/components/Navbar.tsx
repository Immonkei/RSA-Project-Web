    ...
    <nav className="fixed top-0 left-0 right-0 bg-crypto-dark-blue/80 backdrop-blur-md z-50 border-b border-crypto-purple/20">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to="/" className="flex items-center space-x-2 group">
          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-crypto-purple to-crypto-light-purple flex items-center justify-center overflow-hidden group-hover:animate-spin-slow transition-all duration-500">
